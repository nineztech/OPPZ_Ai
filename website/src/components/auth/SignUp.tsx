...
import { Eye, EyeOff, Mail, CheckCircle,Lock,User,AlertCircle} from 'lucide-react';
...
{/* Animated background elements */}
  ...
  <div className="backdrop-blur-xl w-full max-w-3xl rounded-3xl p-8 text-left">
    <div className="mb-8">
     ...
     <div className="text-center">
          ...
          <h1 className="text-3xl font-extrabold text-gray-100">Sing-Up</h1>
  ...
  color: '#f6f7faff', // gray-900
  backdropFilter: 'blur(8px)', // optional: frosted glass effect
